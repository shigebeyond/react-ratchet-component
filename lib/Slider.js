define('src/Slider.jsx', function(require, exports, module) {
  ...
  var _utilsCommon = require('src/utils/common');
  
  var RATCHET = _interopRequireWildcard(_utilsCommon);
  
  var getScroll = function getScroll(target, transformProperty) {
  ...
  var Slider = _react2['default'].createClass({
      ...
      slide: function slide(index) {
          var slider = _reactDom2['default'].findDOMNode(this).querySelector('.slide-group');
      ...
      _setSlideNumber: function _setSlideNumber(offset) {
          var _vars = this._vars;
          var round = offset ? _vars.deltaX < 0 ? 'ceil' : 'floor' : 'round';
      ...
      _onTouchStart: function _onTouchStart(e) {
          ...
          var slider = _vars.slider = e.currentTarget;
          var slideItemLen = slider.children.length;
      ...
      _onTouchMove: function _onTouchMove(e) {
          ...
          _vars.resistance = _vars.slideNumber === 0 && _vars.deltaX > 0 ? _vars.pageX / _vars.sliderWidth + 1.25 : _vars.slideNumber === _vars.lastSlide && _vars.deltaX < 0 ? Math.abs(_vars.pageX) / _vars.sliderWidth + 1.25 : 1;
