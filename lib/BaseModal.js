define('src/BaseModal.jsx', function(require, exports, module) {
  ...
  var _Portal = require('src/Portal.jsx');
  ...
  var _utilsOwnerDocument = require('src/utils/ownerDocument');
  
  var _utilsOwnerDocument2 = _interopRequireDefault(_utilsOwnerDocument);
  
  var _utilsAddEventListener = require('src/utils/addEventListener');
  
  var _utilsAddEventListener2 = _interopRequireDefault(_utilsAddEventListener);
  
  var _utilsAddFocusListener = require('src/utils/addFocusListener');
  ...
  var _utilsGetContainer = require('src/utils/getContainer');
  ...
  var BaseModal = _react2['default'].createClass({
    ...
    onShow: function onShow() {
      var doc = (0, _utilsOwnerDocument2['default'])(this);
      var container = (0, _utilsGetContainer2['default'])(this.props.container, doc.body);
  
      // modalManager.add(this, container, this.props.containerClassName);
  
      this._onFocusinListener = (0, _utilsAddFocusListener2['default'])(this.enforceFocus);
    ...
    checkForFocus: function checkForFocus() {
      if (_domHelpersUtilInDOM2['default']) {
        this.lastFocus = (0, _domHelpersActiveElement2['default'])();
      }
    },
    ...
    focus: function focus() {
      ...
      var current = (0, _domHelpersActiveElement2['default'])((0, _utilsOwnerDocument2['default'])(this));
      var focusInModal = current && (0, _domHelpersQueryContains2['default'])(modalContent, current);
    ...
    enforceFocus: function enforceFocus() {
      ...
      var active = (0, _domHelpersActiveElement2['default'])((0, _utilsOwnerDocument2['default'])(this));
      var modal = this.getDialogElement();
  
      if (modal && modal !== active && !(0, _domHelpersQueryContains2['default'])(modal, active)) {
        modal.focus();
      }
    },
