...
var Link = _react2['default'].createClass({
    ...
    render: function render() {
        ...
        _Object$assign(classes, iconClasses);

        classes = _extends({}, classes, (_extends2 = {}, _extends2[leftClass] = this.props.left, _extends2[rightClass] = this.props.right, _extends2));
