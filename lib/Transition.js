define('src/Transition.jsx', function(require, exports, module) {
  ...
  var Transition = (function (_React$Component) {
    ...
    function Transition(props, context) {
      ...
      _get(Object.getPrototypeOf(Transition.prototype), 'constructor', this).call(this, props, context);
    ...
    _createClass(Transition, [{
      ...
      value: function onTransitionEnd(node, handler) {
        ...
        if (node) {
          (0, _domHelpersEventsOn2['default'])(node, transitionEndEvent, this.nextCallback);
